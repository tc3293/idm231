...
//update text for final!//
  if (month === 3 && day >= 21 || month === 4 && day <= 19) {
      ...
      document.getElementById('text').innerHTML='put text here until final oh god please god god god god yes god no test god text no testing word working not not yes yes no no';
  ...
  document.getElementById('text').innerHTML='put text here until final DADADADADADADADADADADADADADADADADADADADADADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD';
